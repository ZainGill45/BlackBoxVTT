...
<template>
  <button type="button"
          class="flex h-8 w-8 text-nowrap px-1 items-center justify-center border border-neutral-700 bg-neutral-950 text-xs text-neutral-300 transition-[bg] ease-out duration-128
                 hover:cursor-pointer hover:border-neutral-500
