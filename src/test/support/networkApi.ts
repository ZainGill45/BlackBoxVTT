...
export function createMockNetworkApi(
  ...
  return {
    ...
    onDrawingPreview: vi.fn(() => () => undefined),
    onFogPreview: vi.fn(() => () => undefined),
    ...
    onTransformStarted: vi.fn(() => () => undefined),
    ...
    setTransformPreviewRate: vi.fn(async (input) =>
      success(input.transformPreviewRate),
    ),
